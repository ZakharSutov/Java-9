...
public class LambdaDemo {
    ...
    public static Function<Human, String> getFullName =
            human -> human.getFirstname() + " " + human.getName() + " " + human.getLastname();

    public static Function<Human, Human> addYearToHuman =
            human -> new Human(human.getFirstname(), human.getName(), human.getLastname(), human.getAge() + 1,
                    human.getSex()
            );
    public static Nine isAgesLowerMaxAges =
